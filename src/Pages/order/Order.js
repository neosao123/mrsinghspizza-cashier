                      ...
                      return (
                        <tr key={index + order?.productName}>
                          ...
                          <td>
                            {
                              order?.productType === "custom_pizza" ||
                                order?.productType === "special_pizza" ? "$ " + order?.pizzaPrice :
                                "$ " + order.amount
                            }
                          </td>
                        </tr>
      ...
      return (
        <div>
          {toppingsList?.map((topping, index) => {
            ...
            console.log("keyexits", keyExists);
            return (
              <div className="row">
                {/* <div>{topping}</div> */}
                <div className="col-9 text-capitalize pe-0" key={index}>
                ...
                <div className="col-3 text-end m-0 p-0">
                  ...
                  {
                    topping.amount === undefined || Number(topping.amount) === 0 ? "" : "$ " + Number(topping.amount).toFixed(2)
                  }
                </div>
              </div>
            );
